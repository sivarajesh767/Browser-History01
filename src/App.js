              ...
              <li key={each.id} value={searchInput}>
                <div className="browserList">
                  ...
                  <div className="logoUrl-co">
                    ...
                    <button className="button" type="button" onClick={this.onClickButton}><img src="https://assets.ccbp.in/frontend/react-js/delete-img.png" alt="delete" className="delete"/></button>
                  </div>
                </div>
              </li>
            ))}
